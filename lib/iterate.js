...
function advanceIteration(program, state) {
...
function pushStack(program, { functionName, path, pathsStack, ...state }, newFunctionName) {
...
function popStack(program, { pathsStack, ...state }) {
...
function getCurrent(program, state) {
  return getAt(getCurrentBody(program, state), state.path)
}

exports.getDefaultState = getDefaultState
exports.advanceIteration = advanceIteration
